...
export class Car extends TrafficObject
{
    ...
    update(roadBorders: Coordinates[][], traffic: TrafficObject[]): void
    {
        ...
        if (this.sensor)
        {
            ...
            const offsets: number[] = this.sensor.readings.map((s: Coordinates): number => s === null ? 0 : 1 - (s.offset ?? 0));
     ...
     */
    private assessDamage(roadBorders: Coordinates[][], traffic: TrafficObject[]): boolean
    {
